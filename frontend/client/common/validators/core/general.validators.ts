import { COUNTRIES, LANGUAGES, THEMES, TIMEZONES } from "@/common/constants";
import { z } from "@/common/validators/core";

class GeneralSchemasValidator {
  ...
  public static country = z
    ...
    .refine((value: string) => COUNTRIES.includes(value), {
  ...
  public static theme = z
    ...
    .refine((value: any) => THEMES.includes(value), {
  ...
  public static language = z
    ...
    .refine((value: any) => LANGUAGES.includes(value), {
  ...
  public static timeZone = z
    ...
    .refine((value: any) => TIMEZONES.includes(value), {
...
export { GeneralSchemasValidator };
